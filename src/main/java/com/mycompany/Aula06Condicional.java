...
public class Aula06Condicional {
    ...
    public static void main(String[] args) {
        ...
        if (num % 2 == 0) {
         ...
         /**
         * Estrutura condicional simples (if, else if, else)
         * 
         * nesse tipo des estrutura podemos ter mais verificação caso o primeiro if não esteja satisfeito
         * 
         * um exemplo prático pode ser a verificaçõa de IMC
         */
